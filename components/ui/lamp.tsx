  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-white to-slate-300 py-4 bg-clip-text text-center text-6xl font-extrabold tracking-tight leading-[0.9] text-transparent md:text-[12rem] lg:text-[16rem] xl:text-[18rem] 2xl:text-[20rem]"
        style={{
          fontFamily:
