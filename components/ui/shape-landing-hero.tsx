...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-sm sm:text-base md:text-lg text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Engineering, design, marketing, and AI automation. Building scalable products and intelligent systems for faster, smarter growth.
                        </p>
                    </motion.div>
            ...
            {/* Subtle fade-out for seamless transition */}
            <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-background via-background/95 to-transparent pointer-events-none z-10" />
        </div>
    );
}
